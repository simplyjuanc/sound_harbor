...
import {date, integer, numeric, primaryKey, serial, text, timestamp, varchar} from "drizzle-orm/pg-core";
import {ConditionEnum, DatePrecisionEnum, RecordSpeedEnum, UserPreferencesEnum} from "~/server/db/enums";
